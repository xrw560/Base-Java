...
public class MyReflect {
    ...
    public void init() throws Exception {
        className = "cn.ncut.java.base.reflect.Person";
    ...
    public void getNotPrivateMethod() throws Exception {
        ...
        Object object = toStringMethod.invoke(obj);//obj对象执行toStringMethod方法
    ...
    public void otherMethod() throws Exception {
        ...
        System.out.println("/log4j.properties -> " + personClass.getResourceAsStream("/log4j.properties"));
        System.out.println("log4j.properties -> " + personClass.getResourceAsStream("log4j.properties"));

        //判断当前的Class对象表示是否是数组
        System.out.println("personClass是否是数组: " + personClass.isArray());
        System.out.println("是否是数组: " + new String[3].getClass().isArray());

        //判断当前的Class对象表示是否是枚举类
        System.out.println("personClass是否是枚举类: " + personClass.isEnum());
        System.out.println("是否是枚举类: " + Class.forName("cn.ncut.java.base.reflect.City").isEnum());

        //判断当前的Class对象表示是否是接口
        System.out.println("personClass是否是枚举类: " + personClass.isInterface());
        System.out.println("是否是接口: " + Class.forName("cn.ncut.java.base.reflect.TestInterface").isInterface());
